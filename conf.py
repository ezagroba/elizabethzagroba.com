...
FAVICONS = (
     ("icon", "/images/avatar.png", "128x128"),
    )
...
# (translatable)
CONTENT_FOOTER = """
<a rel="me" href="https://chaos.social/@ez" target="_blank"><i class="fab fa-mastodon" aria-hidden="true"></i></a>
...
MARKDOWN_EXTENSIONS = ['markdown.extensions.fenced_code', 'markdown.extensions.codehilite', 'markdown.extensions.extra', 'markdown_image_caption.plugin']
...
TWITTER_CARD = {
    ...
    'site': '@ezagroba',         # twitter nick for the website
    'creator': '@ezagroba',     # Username for the content creator / author.
}
